...
2. 阅读 <a href="" target="_blank">文档</a> 熟悉组件能力使用
...
6. 尝试一些 <a href="" target="_blank">组件示例</a>
7. 完成 <a href="" target="_blank">项目开发调试</a>


**获得帮助**

8.  如果您有问题，请 <a href="https://koodle.cn/index.php/contact-us/" target="_blank">联系我们 </a>
...
此处仅展示部分实例，如果要查看更多示例，可查看 <a href="" target="_blank">Examples </a> 文件夹。
...
如有任何问题，<a href="" target="_blank">联系我们 </a> ，告诉我们如何提供帮助。
